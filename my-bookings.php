            ...
            <div class="col-md-6 mb-3">
                <div class="card bg-dark text-white border-secondary shadow-sm">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="fw-bold text-warning mb-1"><?= htmlspecialchars($b['title']) ?></h5>
                            <p class="text-muted small mb-1">Seats: <strong class="text-success"><?= htmlspecialchars($b['seats_booked']) ?></strong></p>
                            <p class="text-muted small mb-0">Showtime: <?= date('d M Y, h:i A', strtotime($b['show_time'])) ?></p>
                        </div>
                        <div>
                            <a href="ticket.php?id=<?= $b['id'] ?>" class="btn btn-outline-warning btn-sm">View Ticket</a>
                        </div>
                    </div>
                </div>
            </div>
